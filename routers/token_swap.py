"""
Token Swap Router - Handles DEX swap operations via Hummingbot Gateway.
...
router = APIRouter(tags=["Token Swaps"], prefix="/gateway")

# (Previously used global settings for default slippage; removed per revert)
